...
# Use Piper as a fourth direct source whenever a compatible local model is
# available; routing automatically falls back to the modern providers when it
# is not.
...
# server expands this to the full upstream catalog and persists it locally.
...
QWEN_LANGUAGE_NAMES = dict(QWEN_LANGUAGES)


def parse_omnivoice_catalog(markdown: str) -> dict[str, dict[str, object]]:
    """Parse the upstream Markdown language table without dependencies."""
