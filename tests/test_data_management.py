...
class DataManagementTests(unittest.TestCase):
    def setUp(self):
        ...
        self.original_paths = {
            ...
            "SUPPORT_DIR": trainer.SUPPORT_DIR,
        ...
        trainer.SUPPORT_DIR = root / "support"
        ...
        trainer.PIPER_ROOT = root / "piper-sample-generator"
    ...
    def test_payload_counts_each_managed_item_and_does_not_follow_symlinks(self):
        generated = trainer.DATA_DIR / "generated_samples"
        generated.mkdir()
        ...
        self.assertEqual(item["location"], "generated_samples")
