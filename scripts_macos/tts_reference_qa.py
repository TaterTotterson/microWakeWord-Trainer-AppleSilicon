...
ACOUSTIC_LIMITS = {
    ...
    "qwen3": {
        ...
        # Clean Qwen voices occasionally miss Silero VAD while retaining a
        # strongly harmonic speech spectrum.  This avoids rejecting those
        # clips while still rejecting broadband static.
